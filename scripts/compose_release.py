...
_WEB_ENVIRONMENT_KEYS = frozenset("API_HOST API_PORT MAX_UPLOAD_SIZE".split())
_API_ENVIRONMENT_KEYS = frozenset(
    ...
    HF_HOME HOST_BIND_ADDRESS HOST_IP JWT_SECRET_KEY JWT_SECRET_KEY_FILE LOG_LEVEL MAX_UPLOAD_SIZE
    ...
    SELF_REGISTRATION_ENABLED SGLANG_IMAGE SGLANG_TEMPLATE_VOLUME STORAGE_BACKEND
    SWANLAB_API_KEY
    ...
    VLLM_IMAGE XINFERENCE_CONTRACT_VOLUME XINFERENCE_IMAGE XINFERENCE_PATCH_VOLUME
    """.split()
)
    ...
    try:
        ...
        expected_environment = {
            ...
            "train-factory-web": {
                ...
                "MAX_UPLOAD_SIZE": control_values.get("MAX_UPLOAD_SIZE", "524288000"),
            },
        }
