...
_COMPOSE_INTERPOLATION_KEYS = frozenset(
    ...
    JWT_SECRET_KEY JWT_SECRET_KEY_SECRET_PATH LOG_LEVEL MAX_UPLOAD_SIZE MILVUS_DATA_VOLUME
    ...
    VCS_REF VERSION VLLM_IMAGE WEB_DEV_PORT WEB_DEV_PROXY_IPV4 WEB_HOST_BIND_ADDRESS WEB_IMAGE
